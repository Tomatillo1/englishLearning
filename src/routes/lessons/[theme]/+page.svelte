<script lang="ts">
	import { allLessons } from '$lib/all-my-lessons-datas/allLessons';
	...
	const wordsList = allLessons[props.params.theme]?.lessonWords;
...
<main class="h-screen flex flex-col w-full relative pt-4">
	...
	<section class="w-full px-4 pb-20">
		<!-- Todo : change new variable name -->
		<DisplayLessonsWords wordsList={wordsList} />
	</section>
</main>